          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                InkWell(
                  onTap: () async => await canLaunch(
                          "https://www.notion.so/Datenschutz-ab9cbe15077c4b3db2ab86cef2702b7d")
                      ? await launch(
                          "https://www.notion.so/Datenschutz-ab9cbe15077c4b3db2ab86cef2702b7d")
                      : throw 'Der Link funktioniert nicht',
                  child: Text(
                ...
                InkWell(
                  onTap: () async => await canLaunch(
                          "https://www.notion.so/Impressum-e1fa2113d42b46fdb61bf91f66508dd3")
                      ? await launch(
                          "https://www.notion.so/Impressum-e1fa2113d42b46fdb61bf91f66508dd3")
                      : throw 'Der Link funktioniert nicht',
                  child: Text(
                ...
                InkWell(
                  onTap: () async => await canLaunch(
                          "https://www.notion.so/Willkommen-bei-Zample-7639e6c585e74cb5a9da4e58455d88fb")
                      ? await launch(
                          "https://www.notion.so/Willkommen-bei-Zample-7639e6c585e74cb5a9da4e58455d88fb")
                      : throw 'Der Link funktioniert nicht',
                  child: Text(
